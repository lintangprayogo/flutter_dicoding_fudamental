...
import 'package:dicoding_flutter_fudamental/common/navigation.dart';
...
class NotificationHelper {
  ...
  Future<void> showNotification(
    ...
    Restaurant restaurant = restaurantResult.restaurants[0];
    var titleNotification = "<b>Yuk Check Restaurant Favorite Kamu</b>";
  ...
  void configureSelectNotificationSubject(String route) {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        ...
        var resturant = data.restaurants[0];
        Navigation.intentWithData(route, resturant);
      },
    );
  }
}
